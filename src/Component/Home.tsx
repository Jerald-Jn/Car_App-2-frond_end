    ...
    <>
      ...
      <div>
        <div className='relative'>
          <div className='bg-red-700 relative' data-id={index}>
            <a href="">
      ...
      <div className='mt-5'>
        <div className=''>
          ...
          <div className=''>
              <ul className='grid grid-cols-4 grid-flow-row space-x-5 space-y-5  items-center'>
                <a href="" className='ml-5 mt-5 bg-white text-center'>
                ...
                <a href="" className='ml-5 bg-white h-40 text-center'>
                  <li className='flex justify-center '>
                ...
                <a href="" className='bg-white h-40 text-center'>
                  ...
                  <h2 className='text-center uppercase font-bold -mt-2'>innova crysta</h2>
                  <p className='font-medium tracking-wider -mt-1'>From INR 6,90,000*</p>
                </a>
                <a href=""className='bg-white h-40 text-center'>
                  <li className='flex justify-center'>
                    <img className='mt-1' src="./src/assets/innova-hycross.png" alt="" />
                  </li>
                ...
                <a href="" className='bg-white h-40 text-center'>
                  <li className='flex justify-center'>
                    <img className='p-2' src="./src/assets/land-cruser.png" alt="" />
                  </li>
                  <h2 className='text-center uppercase -mt-3.5 font-bold'>land cruser</h2>
                  <p className='font-medium tracking-wider -mt-1'>From INR 6,90,000*</p>
                </a>
                <a href="" className='bg-white h-40 text-center'>
                  <li className='flex justify-center'>
                ...
                <a href="" className='bg-white h-40 text-center'>
                  <li className='flex justify-center'>
                    <img className='p-2 -mt-1' src="./src/assets/rumion.png" alt="" />
                  </li>
                ...
                <a href="" className='bg-white h-40 text-center'>
                  <li className='flex justify-center'>
                    <img className='-mt-1.5 p-2' src="./src/assets/urban-cruiser-hyryder.png" alt="" />
                  </li>
                ...
                {/* <li className='bg-orange-400'><a href=""><img src="./src/assets/urban-cruiser-taisor.png" alt="" /></a></li> */}
              </ul>
          </div>
        </div>
      </div>
