...
function Header({ setShowProducts, setShowService }:
  {
  ...
  return (
    <header className='bg-white' onMouseEnter={() => { setShowProducts(false), setShowService(false) }}>
      <nav className=''>
        <div className='flex justify-between md:mx-5 p-5'>
          <svg className='h-6 w-1/6 hover:cursor-pointer md:-ml-8' onMouseEnter={() => { setShowProducts(false) }} xmlns="http://www.w3.org/2000/svg" width="136" height="24" viewBox="0 0 136 24"><path fill="none" d="M0 0h158v48H0V0z" />
          ...
          <div className='w-3/4'>
            <ul className='flex flex-row gap-5 items-center uppercase text-xs font-bold   md:mt-2 md:-ml-10'>
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer '>
                <a onMouseEnter={() => { setShowProducts(true), setShowService(false) }}>Products</a>
              </li>
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer'>
                <a href="" onMouseEnter={() => { setShowProducts(false), setShowService(false) }}>Visual Showroom</a>
              </li>
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer'>
                <a href="" onMouseEnter={() => { setShowService(true), setShowProducts(false) }}>Service</a>
              </li>
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer'>
                <a href="" onMouseEnter={() => { setShowService(false), setShowProducts(false) }}>T-Care</a>
              </li>
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer'>
                <a href="">Used Cars</a>
              </li>
              ...
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer'>
                <a href="">Buy Online</a></li>
              <li className='tracking-wider underline-offset-8 hover:underline hover:cursor-pointer'>
                <a href="">Toyota India</a>
              </li>
            </ul>
          </div>
          <div className="">
            <Link to={{
              pathname:'/userdetails'
                ...
                <svg className="h-8 w-12 hover:cursor-pointer -mb-2" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='w-10'>
            <img className='h-7 hover:cursor-pointer' src="./src/assets/call-logo.png" alt="" />
          </div>
        </div>
      </nav>
    </header>
